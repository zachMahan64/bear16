...
const std::unordered_set<std::string> validOpcodeMnemonics = {
    ...
    "mult",       "multi",       "multi1",       "multi2",
    "div",        "divi",        "divi1",        "divi2",
    "mod",        "modi",        "modi1",        "modi2",
    "and",        "andi",        "andi1",        "andi2",
    "or",         "ori",         "ori1",         "ori2",
    "xor",        "xori",        "xori1",        "xori2",
    "not",        "noti",        "noti1",        "noti2",
    "nand",       "nandi",       "nandi1",       "nandi2",
    "nor",        "nori",        "nori1",        "nori2",
    "neg",        "negi",        "negi1",        "negi2",
    "lsh",        "lshi",        "lshi1",        "lshi2",
    "rsh",        "rshi",        "rshi1",        "rshi2",
    "rol",        "roli",        "roli1",        "roli2",
    "ror",        "rori",        "rori1",        "rori2",
    "eq",         "eqi",         "eqi1",         "eqi2",
    "ne",         "nei",         "nei1",         "nei2",
    "lt",         "lti",         "lti1",         "lti2",
    "le",         "lei",         "lei1",         "lei2",
    "gt",         "gti",         "gti1",         "gti2",
    "ge",         "gei",         "gei1",         "gei2",
    "ult",        "ulti",        "ulti1",        "ulti2",
    "ule",        "ulei",        "ulei1",        "ulei2",
    "ugt",        "ugti",        "ugti1",        "ugti2",
    "uge",        "ugei",        "ugei1",        "ugei2",
    "z",          "zi",          "zi1",          "zi2",
    "nz",         "nzi",         "nzi1",         "nzi2",
    "c",          "ci",          "ci1",          "ci2",
    "nc",         "nci",         "nci1",         "nci2",
    "n",          "ni",          "ni1",          "ni2",
    "nn",         "nni",         "nni1",         "nni2",
    "mov",        "movi",        "movi1",        "movi2",
    "lw",         "lwi",         "lwi1",         "lwi2",
    "lb",         "lbi",         "lbi1",         "lbi2",
    "comp",       "compi",       "compi1",       "compi2",
    "lea",        "leai",        "leai1",        "leai2",
    "push",       "pushi",       "pushi1",       "pushi2",
    "pop",        "popi",        "popi1",        "popi2",
    "clr",        "clri",        "clri1",        "clri2",
    "inc",        "inci",        "inci1",        "inci2",
    "dec",        "deci",        "deci1",        "deci2",
    "memcpy",     "memcpyi",     "memcpyi1",     "memcpyi2",
    "sw",         "swi",         "swi1",         "swi2",
    "sb",         "sbi",         "sbi1",         "sbi2",
    "lbrom",      "lbromi",      "lbromi1",      "lbromi2",
    "lwrom",      "lwromi",      "lwromi1",      "lwromi2",
    "romcpy",     "romcpyi",     "romcpyi1",     "romcpyi2",
    "mults",      "multsi",      "multsi1",      "multsi2",
    "divs",       "divsi",       "divsi1",       "divsi2",
    "mods",       "modsi",       "modsi1",       "modsi2",
    "mult_fpt",   "mult_fpti",   "mult_fpti1",   "mult_fpti2",
    "div_fpt",    "div_fpti",    "div_fpti1",    "div_fpti2",
    "mod_fpt",    "mod_fpti",    "mod_fpti1",    "mod_fpti2",
    "call",       "calli",       "calli1",       "calli2",
    "ret",        "reti",        "reti1",        "reti2",
    "jmp",        "jmpi",        "jmpi1",        "jmpi2",
    "jcond_z",    "jcond_zi",    "jcond_zi1",    "jcond_zi2",
    "jcond_nz",   "jcond_nzi",   "jcond_nzi1",   "jcond_nzi2",
    "jcond_neg",  "jcond_negi",  "jcond_negi1",  "jcond_negi2",
    "jcond_nneg", "jcond_nnegi", "jcond_nnegi1", "jcond_nnegi2",
    "jcond_pos",  "jcond_posi",  "jcond_posi1",  "jcond_posi2",
    "jcond_npos", "jcond_nposi", "jcond_nposi1", "jcond_nposi2",
    "nop",        "nopi",        "nopi1",        "nopi2",
    "hlt",        "hlti",        "hlti1",        "hlti2",
    "jal",        "jali",        "jali1",        "jali2",
    "retl",       "retli",       "retli1",       "retli2",
};
...
const std::vector<std::string> namedOperandsInOrder{
    ...
    // special-purpose
    "r29", "sp", "r30", "fp", "r31", "pc"};

const std::unordered_map<std::string, isa::Opcode_E> stringToOpcodeMap = {
    // Arith & Bitwise
    {"add", isa::Opcode_E::ADD},
    {"sub", isa::Opcode_E::SUB},
    {"mult", isa::Opcode_E::MULT},
    {"div", isa::Opcode_E::DIV},
    {"mod", isa::Opcode_E::MOD},
    {"and", isa::Opcode_E::AND},
    {"or", isa::Opcode_E::OR},
    {"xor", isa::Opcode_E::XOR},
    {"not", isa::Opcode_E::NOT},
    {"nand", isa::Opcode_E::NAND},
    {"nor", isa::Opcode_E::NOR},
    {"neg", isa::Opcode_E::NEG},
    {"lsh", isa::Opcode_E::LSH},
    {"rsh", isa::Opcode_E::RSH},
    {"rol", isa::Opcode_E::ROL},
    ...
    {"gt", isa::Opcode_E::GT},
    {"ge", isa::Opcode_E::GE},
    {"ult", isa::Opcode_E::ULT},
    {"ule", isa::Opcode_E::ULE},
    {"ugt", isa::Opcode_E::UGT},
    {"uge", isa::Opcode_E::UGE},
    {"z", isa::Opcode_E::Z},
    {"nz", isa::Opcode_E::NZ},
    {"c", isa::Opcode_E::C},
    {"nc", isa::Opcode_E::NC},
    ...
    // Data Trans
    {"mov", isa::Opcode_E::MOV},
    {"lw", isa::Opcode_E::LW},
    {"lb", isa::Opcode_E::LB},
    {"comp", isa::Opcode_E::COMP},
    {"lea", isa::Opcode_E::LEA},
    {"push", isa::Opcode_E::PUSH},
    {"pop", isa::Opcode_E::POP},
    {"clr", isa::Opcode_E::CLR},
    {"inc", isa::Opcode_E::INC},
    {"dec", isa::Opcode_E::DEC},
    {"memcpy", isa::Opcode_E::MEMCPY},
    {"sw", isa::Opcode_E::SW},
    {"sb", isa::Opcode_E::SB},
    {"lbrom", isa::Opcode_E::LBROM},
    {"lwrom", isa::Opcode_E::LWROM},
    {"romcpy", isa::Opcode_E::ROMCPY},
    {"mults", isa::Opcode_E::MULTS},
    {"divs", isa::Opcode_E::DIVS},
    {"mods", isa::Opcode_E::MODS},
    {"mult_fpt", isa::Opcode_E::MULT_FPT},
    {"div_fpt", isa::Opcode_E::DIV_FPT},
    {"mod_fpt", isa::Opcode_E::MOD_FPT},

    // Ctrl Flow
    {"call", isa::Opcode_E::CALL},
    {"ret", isa::Opcode_E::RET},
    {"jmp", isa::Opcode_E::JMP},
    {"jcond_z", isa::Opcode_E::JCOND_Z},
    {"jcond_nz", isa::Opcode_E::JCOND_NZ},
    {"jcond_neg", isa::Opcode_E::JCOND_NEG},
    {"jcond_nneg", isa::Opcode_E::JCOND_NNEG},
    {"jcond_pos", isa::Opcode_E::JCOND_POS},
    {"jcond_npos", isa::Opcode_E::JCOND_NPOS},
    {"nop", isa::Opcode_E::NOP},
    {"hlt", isa::Opcode_E::HLT},
    {"jal", isa::Opcode_E::JAL},
...
const std::unordered_map<isa::Opcode_E, int> opcodeToOperandMinimumCountMap = {
    ...
    {isa::Opcode_E::ROL, 3},
    {isa::Opcode_E::ROR, 3},
    {isa::Opcode_E::MULTS, 3},
    {isa::Opcode_E::DIVS, 3},
    {isa::Opcode_E::MODS, 3},
    {isa::Opcode_E::MULT_FPT, 3},
    {isa::Opcode_E::DIV_FPT, 3},
    ...
    {isa::Opcode_E::MOV, 2},
    {isa::Opcode_E::LW, 2},
    {isa::Opcode_E::LB, 2}, //(3) but offset
    {isa::Opcode_E::COMP, 2},
    ...
    {isa::Opcode_E::CLR, 1},
    {isa::Opcode_E::INC, 1},
    {isa::Opcode_E::DEC, 1}, // dest only
    {isa::Opcode_E::MEMCPY, 3},
    {isa::Opcode_E::ROMCPY, 3},
    {isa::Opcode_E::SW, 2},
    {isa::Opcode_E::SB, 2}, //(3) but offset (in src1!)
    {isa::Opcode_E::LWROM, 2},
    {isa::Opcode_E::LBROM, 2}, //(3) but offset

    // Ctrl Flow
    {isa::Opcode_E::CALL, 1},
    {isa::Opcode_E::RET, 0},
    {isa::Opcode_E::JMP, 1},
    {isa::Opcode_E::JCOND_Z, 1},
    {isa::Opcode_E::JCOND_NZ, 1},
    {isa::Opcode_E::JCOND_NEG, 1},
    {isa::Opcode_E::JCOND_NNEG, 1},
    {isa::Opcode_E::JCOND_POS, 1},
    {isa::Opcode_E::JCOND_NPOS, 1},
    {isa::Opcode_E::NOP, 0},
    {isa::Opcode_E::HLT, 0},
    {isa::Opcode_E::JAL, 1},
    {isa::Opcode_E::RETL, 0}};
...
void asmMnemonicSetGenerator() {
  ...
  const std::vector<Instr> instructions = {
      {"add", 0x0000},        {"sub", 0x0001},       {"mult", 0x0002},
      {"div", 0x0003},        {"mod", 0x0004},       {"and", 0x0005},
      {"or", 0x0006},         {"xor", 0x0007},       {"not", 0x0008},
      {"nand", 0x0009},       {"nor", 0x000A},       {"neg", 0x000B},
      {"lsh", 0x000C},        {"rsh", 0x000D},       {"rol", 0x000E},
      {"ror", 0x000F},        {"eq", 0x0010},        {"ne", 0x0011},
      {"lt", 0x0012},         {"le", 0x0013},        {"gt", 0x0014},
      {"ge", 0x0015},         {"ult", 0x0016},       {"ule", 0x0017},
      {"ugt", 0x0018},        {"uge", 0x0019},       {"z", 0x001A},
      {"nz", 0x001B},         {"c", 0x001C},         {"nc", 0x001D},
      {"n", 0x001E},          {"nn", 0x001F},        {"mov", 0x0020},
      {"lw", 0x0021},         {"lb", 0x0022},        {"comp", 0x0023},
      {"lea", 0x0024},        {"push", 0x0025},      {"pop", 0x0026},
      {"clr", 0x0027},        {"inc", 0x0028},       {"dec", 0x0029},
      {"memcpy", 0x002A},     {"sw", 0x002B},        {"sb", 0x002C},
      {"lbrom", 0x002D},      {"lwrom", 0x002E},     {"romcpy", 0x002F},
      {"mults", 0x0030},      {"divs", 0x0031},      {"mods", 0x0032},
      {"mult_fpt", 0x0033},   {"div_fpt", 0x0034},   {"mod_fpt", 0x0034},
      {"call", 0x0040},       {"ret", 0x0041},       {"jmp", 0x0042},
      {"jcond_z", 0x0043},    {"jcond_nz", 0x0044},  {"jcond_neg", 0x0045},
      {"jcond_nneg", 0x0046}, {"jcond_pos", 0x0047}, {"jcond_npos", 0x0048},
      {"nop", 0x0049},        {"hlt", 0x004A},       {"jal", 0x004B},
      {"retl", 0x004C},
  };
...
std::vector<uint8_t> Assembler::assembleOpenedProject() {
  ...
  std::vector<TokenizedRomLine> allTokenizedInstructions =
    ...
    if (inChar) {
      if (c == '\'') {
        ...
        if (currentStr.length() > 1) {
          LOG_ERR(
              "ERROR: invalid char declaration (length greater than 1 char)");
        }
...
std::vector<TokenizedRomLine> Assembler::parseListOfTokensIntoTokenizedRomLines(
  ...
  // break down into lines --> count lines for labels, resolve declarations and
  // usages of labels/const --> form tokenized instructions
  ...
  for (const Token &tkn : tokens) {
    ...
    if (!inText && !inData &&
      ...
      if (inData)
        currentLine_DATA.push_back(tkn);
      ...
      if (inText)
        currentLine_TEXT.push_back(newTkn);
      if (inData) {
          ...
          try {
            if (line.at(3).type == TokenType::DECIMAL) {
              ...
              if (!issuedFixPtConstWarning) {
                LOG_ERR("CAUTION: fixed point constant will not be supported "
                        "in expressions");
            ...
            LOG_ERR("ERROR: bad const value: " << line.at(3).body << " ("
                                               << e.what() << ")");
            throw;
          }
          if (auto [it, inserted] = constMap.emplace(line.at(1).body, value);
              !inserted) {
  ...
  for (std::vector<Token> &line : tokenLines_TEXT_and_DATA) {
    ...
    if (firstTknType == TokenType::OPERATION) {
      ...
      TokenizedInstruction instrForThisLine =
          parseLineOfTokensIntoTokenizedInstruction(line, labelMap, constMap,
                                                    byteIndex);
...
TokenizedInstruction Assembler::parseLineOfTokensIntoTokenizedInstruction(
  ...
  std::vector<Token> revisedTokens{}; // use this to build finalized operands,
    ...
    if (tkn.type == TokenType::REF) {
      if (labelMap.contains(tkn.body)) {
        ...
        LOG_ERR("ERROR: bad reference: "
                << tkn.body << " " << toString(tkn.type) << " in instruction #"
                << +instructionIndex);
  ...
  for (const Token &tkn : revisedTokens) {
    if (tkn.type == TokenType::LBRACKET) {
      ...
      if (tokensForOperand.size() == 2 &&
        ...
        LOG_ASM("Empty char literal detected. Assumed a space was written or "
                "intended -> substituted with \\s");
      }
      ...
      if (tokensForOperand.size() == 2 &&
        ...
        tokensForOperand = {Token("'"), Token("\\s"), Token("'")};
        LOG_ASM("Empty string literal detected. Assumed a space was written or "
                "intended -> substituted with \\s");
      }
...
TokenizedData Assembler::parseLineOfTokensIntoTokenizedData(
  ...
  std::vector<Token>
      revisedDataTokens{}; // use this to build finalized data tokens, also make
                           // a function for this
    ...
    if (dataDirectivesToSizeMap.contains(tkn.type) ||
      ...
      if (tkn.type == TokenType::REF) {
        if (labelMap.contains(tkn.body)) {
          ...
          LOG_ASM(".data: converted raw REF to STRING since ref was not found "
                  "in label or const map:" +
                  fixedStrTkn.body);
          if (firstTkn.type != TokenType::STRING_DIR) {
            LOG_ERR("ERROR: misused string or invalid reference in directive "
      ...
      LOG_ERR(
          "ERROR: bad data/directive in .data section: " << toString(tkn.type));
    }
  }
...
Operand::Operand(std::vector<Token> tokens)
  ...
  if (this->tokens.size() == 1) {
    ...
    } // handles the weird edge case of single letter operations! + symbols as
      // operand chars not working
...
// methods for resolving tokenized instr into
// literals-------------------------------------------------------------------
