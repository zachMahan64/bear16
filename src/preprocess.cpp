...
// Include Token
// ----------------------------------------------------------------------------------------------------
IncludeToken::IncludeToken(std::string fileName, std::string projectPath)
...
std::string IncludeToken::getFullPath() const { return fullPath; }
std::string IncludeToken::getContents() const { return contents; }
std::string IncludeToken::getFileName() const { return fileName; }
