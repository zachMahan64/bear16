...
//maps & sets ----------------------------------------------------------------------------------------------------------
const std::unordered_set<std::string> assembly::validOpcodeMnemonics = {
    "add",
    "addi",
    "addi1",
    "addi2",
    ...
    "bliti1",
    "bliti2",};
const std::unordered_map<std::string, uint16_t> assembly::namedOperandToBinMap = {
    ...
    {"fp", 19},
    {"pc", 20}};
const std::unordered_map<std::string, isa::Opcode_E> assembly::stringToOpcodeMap = {
    // Arith & Bitwise
...
const std::unordered_map<isa::Opcode_E, int> assembly::opcodeToOperandMinimumCountMap = {
        // Arith & Bitwise
...
const std::unordered_set<isa::Opcode_E> assembly::opCodesWithOptionalSrc2OffsetArgument = {
        isa::Opcode_E::LW,
        isa::Opcode_E::LB,
        isa::Opcode_E::LEA
        };
const std::unordered_set<isa::Opcode_E> assembly::opCodesWithOptionalSrc1OffsetArgument = {
        isa::Opcode_E::SW, isa::Opcode_E::SB
    };
const std::unordered_set<char> assembly::validSymbols = {
        '!', '@', '/', '\\', '$', '%', '&', '^', '*', '(', ')', '\'', '~', '-', '\0'
    };
const std::unordered_map<std::string, assembly::TokenType> assembly::directivesMap = {
    {".string", assembly::TokenType::STRING_DIR},
    {".byte", assembly::TokenType::BYTE_DIR},
    {".octbyte", assembly::TokenType::OCTBYTE_DIR},
    {".word", assembly::TokenType::WORD_DIR},
    {".word", assembly::TokenType::QWORD_DIR},};
//tools ----------------------------------------------------------------------------------------------------------------
void assembly::asmMnemonicSetGenerator() {
    ...
    std::cout << "const std::unordered_set<std::string> assembly::validOpcodeMnemonics = {\n";
...
assembly::Assembler::Assembler(bool enableDebug, bool doNotAutoCorrectImmediates)
